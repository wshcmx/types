...
{
    [XmlRoot("dn_discipline_block")]
    public class DnDisciplineBlock
    {
        /// <summary>
        /// Роль пользователя
        /// </summary>
        ...
        public List<DnDisciplineBlockDocumentDiscipline> Disciplines { get; set; } = new List<DnDisciplineBlockDocumentDiscipline>();
        ...
        [XmlElement("view")]
        public DnDisciplineBlockDocumentView? View { get; set; }
    }
